...
of the growth model equations. For stress-based growth, one would update the stress tensor rather than the strain tensor, and for additive growth laws, one would add the cumulative and incremental growth tensors instead of multiplying them together. \par
\begin{algorithm} 
...
The models we compared were developed to capture different aspects of growth and were tuned to 
