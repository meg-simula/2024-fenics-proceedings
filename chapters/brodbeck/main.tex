...
\end{equation}
the equation system resulting from the saddle point problem \cref{eq:eqlb_ws_constrmin}, a Schur complement-based solver, is implemented. The vectors $\vec{u}_{R1}$ and $\vec{u}_{R2}$ denote the degrees of freedom (DOFs) for the rows of the stress tensor.
