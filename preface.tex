...
the Simula Research Laboratory in Oslo, Norway. It was the 19th -- or possibly
-- the 20th FEniCS Conference, with the records of the 2007 edition remaining
inconclusive, despite some senior community members claiming that they attended.
Fittingly, the 2024 edition of the conference will be permanantly marked by
this first peer-reviewed conference proceedings, published as part of the
\emph{Simula SpringerBriefs on Computing} series.

The conference brought together developers, existing and potential users of the
...
\begin{itemize}
	\item \emph{Best poster}. Alena Jarolímová, Charles University, Czech
		Republic for their poster ``Determination of Navier’s slip
	...
	\item \emph{Best presentation by a doctoral student}. Alexandre Guibert,
		University of California San Diego, with the presentation
	...
	\item \emph{Best presentation by a postdoctoral researcher}. Igor
		Tominec, Stockholm University, with the presentation ``On the
	...
	\item \emph{Nate Sime's award for exceptional FEniCS visualization}.
		Marc Hirschvogel, Politecnico di Milano, contained in the
		presentation ``Block Preconditioners for (Moving Domain) Fluid
		Dynamics Coupled to Physics- and Projection-based Reduced
		Models''.
\end{itemize}
Thanks to the generous support of the Ridway Scott Foundation and Nate Sime,
each winner received a cash prize.

Three travel awards were 

We would like to thank all authors and reviewers for their contributions and
engagement, and to the organisers and local hosts for creating such a welcoming
environment. Their combined efforts exemplify the openness that continues to
drive the FEniCS Project forward.
